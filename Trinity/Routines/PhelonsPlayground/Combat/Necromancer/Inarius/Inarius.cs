...
{
    public partial class Inarius : RoutineBase, IRoutine
    {
        #region Definition

        public string DisplayName => "Necrosploder";
        public string Description => "Phelons Playground - Necromancer Inarius Set";
        ...
        public Build BuildRequirements => new Build
        {
            ...
            Skills = new Dictionary<Skill, Rune>
            {
                ...
                { Skills.Necromancer.BoneSpear, null },
            },
        };
        ...
        public Rathma.Rathma.RathmaSettings Settings { get; } = new Rathma.Rathma.RathmaSettings();
