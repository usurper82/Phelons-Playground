...
/*
 * Modified with added OpenCommand DependencyProperty, 
 * which fires a command every time modal is opened
 * -XZJV
 */
...
namespace Trinity.UI.UIComponents.Controls
{
    ...
    public class ModalContentPresenter : FrameworkElement
    {
        ...
        /// <summary>
        /// Identifies the ModalContentPresenter.OpenCommand property.
        /// </summary>
        /// <returns>
        /// The identifier for the ModalContentPresenter.OpenCommand property.
        /// </returns>
        ...
        /// <summary>
        /// Gets or sets the command to execute when modal is opened.
        /// </summary>
        ...
        {
            CommandBinding showModalCommandBinding = new CommandBinding(ModalContentCommands.ShowModalContent, (sender, args) =>
            {
                this.ShowModalContent();
                this.OpenCommand.Execute(args.Parameter);

            }, (sender, args) => args.CanExecute = !this.IsModal);
